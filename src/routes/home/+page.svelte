...
<script lang="ts">
  ...
  <section class="flex items-center justify-center min-h-screen px-8 bg-[#191919] text-white relative">
    <div class="absolute inset-0 flex flex-col items-center">
      <h1 class="lg:text-[20vw] leading-none tracking-tight uppercase max-w-full z-[0]">
        About<br>
        <span class="block pl-30">Us</span>
      </h1>
